...
Route::get('/fetchQuestions', 'VisiteurController@fetchQuestions')->name('fetchQuestions');
...
Route::post('admin/add-events', 'EventsController@addEvents')->name('admin.addEvent');
});
