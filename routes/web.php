...
', 'AdministrateurController@fProjet')->name('admin.freelance');
	...
	Route::post("/admin/api/users/", "AdministrateurController@createApiUser");
	Route::get("/admin/api/users/{id}/refresh", "AdministrateurController@refreshApiUserToken")->where('id', '[0-9]+');
	Route::get('admin/api/users', 'AdministrateurController@apiUserIndex')->name('admin.api.users');
});
