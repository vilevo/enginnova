...
@section('titre')
	Enginnova Community - Catégorie Questions
@endsection
...
<div class="mu-page-breadcrumb-area">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active" style="color: gold;">Catégorie question</li>
    </ol>
</div>
@endsection
                  ...
                  <div class="row">
                    <div class="col-md-9">
                      ...
                      <div class="panel-body">
                        ...
                        {{ $posts->links() }}
                      @else
                        <div class="alert alert-danger"><h5>Pas de questions de cette catégorie disponible pour le moment.</h5></div>
                      @endif
                      </div>
                    </div>
                    </div>
