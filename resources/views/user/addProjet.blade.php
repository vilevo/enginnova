        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h3>Quel est le titre de votre projet?</h3>
              ...
              <form role="form" action="{{ url('user/insertProjet') }}" method="POST">
                  <div class="box-body">
                   {{csrf_field()}}
                      ...
                      @endif
                        ...
                        <div class="input-group">
                          <input type="text" required="required" size="30" class="form-control" id="exampleInputEmail1" placeholder="100.000" name="prix">
