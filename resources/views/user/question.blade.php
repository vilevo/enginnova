                      ...
                      <div class="panel-body">
                          ...
                          <ul class="mu-news-single-tagnav">
                            ...
                            @if( $post->id_user == Auth::user()->id )
                              <li>Options :</li>
                              <li><a class="" href='{{ url("user/edit-question/{$id}") }}' style="color: maroon;"><span class="fa fa-gear" style="color: gray;"></span> <b>Gérer</b></a></li>
                              <li><a class="" href='{{ url("user/deleteQuestion/{$id}") }}' style="color: maroon;"><span class="fa fa-remove" style="color: red;"></span> <b>Supprimer</b></a></li>
                            @endif
                          </ul>
                         </div>
                    </div>
                            ...
                            <li>
                              <div class="media">
                                ...
                                <div class="media-body">
                                 ...
                                 <?php $idc = $commentaire->id_commentaire*1000; 
                                       $idu = $commentaire->id_user*1000; ?>        
                                  <a class="" href='{{ url("user/like-solution/{$idc}/{$idu}/{$id}") }}' style="color: #337AB7;"><i class="fa fa-thumbs-up" style="color: #337AB7;"></i> Vrai {{$commentaire->count_vote}}</a>
                                 @if($commentaire->id_user == Auth::user()->id)
                                     <!-- <a class="" href='{{ url("user/edite-solution/{$idc}/{$id}") }}'><span class="fa fa-edit"></span> modifier</a> -->
                                     <a class="" href='{{ url("user/deleteSolution/{$idc}/{$id}") }}' style="color: #337AB7;">| <i class="fa fa-remove" style="color: maroon;"></i> Supprimer</a>
                                 @endif
                                </div>
                              </div>
                            </li>
