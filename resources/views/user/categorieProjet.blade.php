...
<div class="mu-page-breadcrumb-area">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active" style="color: gold;">Catégorie projet</li>
    </ol>
</div>
@endsection
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-9">
                      ...
                      @else
                        <div class="alert alert-danger"><h5>Pas de projet de cette catégorie disponible pour le moment.</h5></div>
                      @endif
                      </div>
                    </div>
                    </div>
