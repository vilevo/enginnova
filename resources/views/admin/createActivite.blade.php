...
@section('titre')
    Administration - Create activité
@endsection
            ...
            <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="cv">
                        	...
                        	<form role="form" action='{{ url("admin/create-activite") }}' method="POST" enctype="multipart/form-data">
			              <div class="box-body">
			               {{csrf_field()}}
	                	...
	                	@if(!empty($activites))
	                		<ul>
	                			...
	                			<li><a href='{{ url("admin/edit-activite/{$activite->id}") }}'>{{ $activite->titre }}</a></li>
	                			@endforeach
	                		</ul>
	                	@else
	                	@endif
