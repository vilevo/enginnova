            ...
            <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="freelance_projet">
                        	...
                        	@if(!empty($new_boosts))
             				<h5 class="label label-danger">Total Projets à booster : {{count($new_boosts)}}</h5><br><br>
                        		<ul class="mu-sidebar-catg">
                        		<?php $i=1; ?>
                        		@foreach($new_boosts->all() as $new_boost)
                        			<li><a href='{{ url("admin/admin-freelanceProjet/$new_boost->id_fprojet") }}' style="color: #337AB7;">Projet {{$i++}}</a></li>
                        		@endforeach
                        		</ul>
                        	@else
                        	<h4>RAS</h4>
