...
<meta property="og:image" content="https://enginnova.s3-us-west-2.amazonaws.com/<?php echo $astuce->photo; ?>">
@endsection
       ...
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <ol class="breadcrumb pull-right">
            ...
            <li class="active" style="color: gold;">Infos et astuces Tech</li>
          </ol>
         </div>
       </div>
     </div>
                            ...
                            <div class="box-header with-border">
                              <div class="user-block">
                                ...
                                <figure class="mu-blog-single-img">
                          			<a href="#"><img alt="img" class="img-responsive" src="https://enginnova.s3-us-west-2.amazonaws.com/<?php echo $astuce->photo; ?>" alt="image"></a>
                          		</figure><br>
                                <span style="font-size: 16px; font-weight: 600;"><a href='{{ url("geeking/{$astuce->id}") }}'>{{$astuce->titre}}</a></span><br>
                                  ...
                                  @foreach($similaires->all() as $similaire)
                                    <div class="media">
    					                        <div class="media-left">
    					                          <a href="#">
    					                            <img class="media-object" src="https://enginnova.s3-us-west-2.amazonaws.com/<?php echo $similaire->photo; ?>" class="img-responsive" width="50" height="50" alt="image">
    					                          </a>
    					                        </div>
    					                        <div class="media-body">
